...
const phase1: CurriculumRow[] = [
  {
    month: monthLabel('Month 1', 'LLM Foundations'),
  ...
  {
    month: monthLabel('Month 2', 'Prompting, Embeddings & Vector Search'),
  ...
  {
    month: monthLabel('Month 3', 'RAG Systems In-Depth'),
    ...
    milestone: 'Can build a RAG system that retrieves the right context and shows where it came from.',
  },
];

const phase2: CurriculumRow[] = [
  {
    month: monthLabel('Month 4', 'AI Agents & Tool Use'),
  ...
  {
    month: monthLabel('Month 5', 'Multi-Agent Systems & Orchestration'),
  ...
  {
    month: monthLabel('Month 6', 'Evaluation, Guardrails & Deployment'),
    ...
    milestone: 'Can build it, evaluate it, guard it, and ship it, and prove it works with numbers, not vibes.',
  },
];

const phase3: CurriculumRow[] = [
  {
    month: monthLabel('Month 7', 'Fine-Tuning & Model Customization'),
  ...
  {
    month: monthLabel('Month 8', 'Advanced RAG & Agentic Architectures at Scale'),
  ...
  {
    month: monthLabel('Month 9', 'Production AI Systems & Career'),
    ...
    <>
      <section className="border-b border-border">
        <div className="container flex flex-col gap-6 py-16 sm:py-20">
          <span className="text-sm text-muted-foreground">Track 02</span>
      ...
      <section className="container py-16">
        <SectionHeading
          ...
          dek="Months 1 through 3. The goal is to take you from zero to RAG engineer."
        />
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          ...
          (Month 3) rather than being folded into general "AI basics" — it&apos;s the single
      ...
      <section className="container pb-16">
        <SectionHeading
          ...
          dek="Months 4 through 6. The goal is to take you from RAG engineer to agentic AI developer."
        />
      ...
      <section className="border-y border-border bg-secondary/30">
        <div className="container py-16">
          <SectionHeading
            title="Mastery Specialization (optional)"
            dek="Months 7 through 9. The goal is to take you from agentic AI developer to AI systems specialist."
          />
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            ...
            who want to specialize beyond shipping an AI feature into owning AI infrastructure and
            making build, fine-tune, or buy decisions.
          </p>
        </div>
      </section>
      ...
      <section className="container py-16">
        <SectionHeading
          title="Deep dive: RAG architecture"
          dek="Reference material for instructors building slides and labs. Taught across Month 3 (core) and Month 8 (agentic, at scale)."
        />
      ...
      <section className="container pb-16">
        <SectionHeading
          title="Deep dive: agents & multi-agent systems"
          dek="Taught across Months 4 and 5 (core) and Month 8 (at scale)."
        />
        <DeepDiveGrid groups={agentsDeepDive} />
        <p className="mt-4 text-sm text-muted-foreground">
          <strong className="text-foreground/90">When not to use multi-agent:</strong> a running
          theme through Month 5 — many problems that look like they need multiple agents are
          better served by one agent with more tools, or a plain pipeline with no agent at all.
        </p>
      </section>
      ...
      <section className="border-t border-border bg-secondary/30">
        <div className="container py-16">
          <SectionHeading
            title="Deep dive: evaluation & guardrails"
            dek="Taught in Month 6 (core), with observability extending into Month 9."
          />
          <DeepDiveGrid groups={evalDeepDive} />
          <p className="mt-4 text-sm text-muted-foreground">
            <strong className="text-foreground/90">Red-teaming:</strong> students red-team each
            other&apos;s flagship apps with adversarial prompts, injection attempts, and jailbreak
            tries, then patch what breaks and build a lightweight regression suite so a guardrail
            fix doesn&apos;t silently break next month.
          </p>
        </div>
      </section>

      <section className="container py-16">
        <SectionHeading title="Capstone projects & career outcomes" />
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="flex flex-col gap-2 text-sm leading-relaxed text-foreground/90">
              <li className="border-l-2 border-primary/40 pl-3">
                Portfolio: a GitHub repo with architecture diagram, eval scorecard, and a short demo
                video per project.
              </li>
              <li className="border-l-2 border-primary/40 pl-3">
        ...
        <div className="mt-10">
          <div className="mb-3 text-sm text-muted-foreground">Target roles at completion</div>
          <div className="flex flex-wrap gap-2">
